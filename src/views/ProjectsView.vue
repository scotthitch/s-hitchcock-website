...
// const projects = shallowRef([FourierSeriesProject, WaterfallProject])
// const projects2 = shallowRef([PerlinFlowFieldProject, GrowingCircleProject])
...
<template>
    <div class="snap-y snap-mandatory h-screen overflow-scroll">
        <component v-for="project in projects" v-bind:is="project" v-bind:key="project.title">
        </component>
    </div>
</template>
