...
<template>
    <div class="content-center p-6 sm:p-8 lg:p-16">
        <div class="text-col-primary text-4xl font-bold italic md:text-5xl">
            Thank you for visiting.
        </div>

        <div class="text-col-primary py-2 text-lg font-semibold sm:pb-8 sm:pt-6">
