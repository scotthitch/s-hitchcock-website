...
<template>
    <div class="content-center p-6 sm:p-8 lg:p-16">
        <div class="text-4xl font-bold italic text-col-dark md:text-5xl">
            Thank you for visiting.
        </div>

        <div class="py-2 text-lg font-semibold text-col-dark sm:pb-8 sm:pt-6">
